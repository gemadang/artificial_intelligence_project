...
var sketch = function( p ) { 
  ...
  */
  ...
  var predict_button;
  var text_title;
  var title_text = "Doodle Pal With Sketch-RNN.js";
  ...
  var redraw_screen = function() {
    ...
    //   }
    // }
        origin_x[0][0] = outsize+screen_width/2;
        origin_y[0][0] = outsize;

    p.stroke(0.5);
    p.strokeWeight(0.5);
    p.rect(1, 1, screen_width-1, screen_width/2-1);
    p.line(screen_width/2, 1, screen_width/2, screen_width/2);
    //p.strokeStyle(255,255,255);
    ...
    var scaled_strokes = model.scale_drawing_by_factor(raw_strokes, 1.0);
    ...
    for (i=0;i<Nsize;i++) {
      for (j=0;j<Nsize;j++) {
        ...
        draw_example(raw_strokes, o_x+start_x/scale, o_y+start_y/scale, raw_line_color, line_width);
  ...
  var model_sel_event = function() {
    ...
    var call_back = function(new_model) {
      ...
      restart_all_models();
      encode_all_models(strokes);
      set_title_text('Doodle Pal with Sketch-RNN.js. Now drawing a '+model.info.name);
    ...
    set_title_text('Loading model..... '+c+'...<br/><br/><br/>');
